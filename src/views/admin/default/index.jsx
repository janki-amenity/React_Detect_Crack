  ...
  const handleSend = async () => {
    if (selectedImages.length > 0) {
      ...
      try {
        ...
        // Prepare array to hold promises for Fire store document additions
        const docPromises = [];
        // console.log("imageName 2",);

        // Upload each image to Firebase Cloud Storage and store metadata in Fire store
        ...
        // Wait for all Fire store operations to complete
